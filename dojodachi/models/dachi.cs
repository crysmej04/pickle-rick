    ...
    public class Dachi
    {
        ...
        public Dachi feed()
        {
            ...
            if(chance == 0){
                ...
                this.status = $"Your dachi found some chimichangas and is {amount} fuller!!!";
                return this;
            } else {         
                this.meals-=1;
        ...
        public Dachi play()
        {
            ...
            if(chance == 0){
                this.status = "Your dachi does not want to play right now...";
                return this;
            } else {         
                this.energy-=5;
                int amount = rando.Next(5,11);
        ...
        public Dachi work()
        {
            ...
            this.meals += amount;
            this.status = $"Your dachi somehow worked and earned {amount} meals!";
            return this;
        }
        ...
        public Dachi sleep()
        {
            ...
            this.happiness-=5;
            this.energy+=15;
            this.status = $"Your dachi knocked out for a while. Fullness -5, Energy +15!";
            return this;
        }
    }
}